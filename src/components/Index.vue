                                ...
                                <div class="title-box">
                                    ...
                                    <div class="rating" v-if="form.package_id == 1">
                                        <ul>
                                            ...
                                            <li class="info"><a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="What is Lorem Ipsum?"><img src="../assets/images/info.png"></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="row booking-row">
                                    ...
                                    <div class="col-lg-6 col-md-12 text-center text-lg-end text-md-center text-sm-center">
                                        <div class="info">
                                            <button class="tooltipbtn btn-info" data-toggle="tooltip" data-placement="top" title="What is Lorem Ipsum?">Secured</button>
                                            <button class="tooltipbtn btn-danger" data-toggle="tooltip" data-placement="top" title="What is Lorem Ipsum?">Health & Safety</button>
                                        </div>
                                    </div>
                                </div>
                                <form @submit.prevent="submit">
                                    <div class="row date-booking-row align-items-center">
                                        ...
                                        <div class="col-xl-6 position-relative" @click="onchangeNew()">
                                            ...
                                            <div class="row select-time">
                                                <div class="col-12">
                                                    ...
                                                    <div class="radio-toolbar" v-if="dateTimeArr.length > 0" >
                                                        <div class="time-item" v-for="name in dateTimeArr" :key="name.Id" @click="timedate(name.Id, name.Time)">
                                                            <input  type="radio" :id="name.Id" name="timedate" :value="name.Time" />
                                                            <label :for="name.Id">{{ name.Time}}</label>
                                                        </div>
                                                    </div>
                                                    <div class="radio-toolbar" v-else><h2>Slot not found</h2></div>
                                                </div>
                                            </div>
                                            <hr>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="scroll-table">
                                                        <table class="table">
                                                            ...
                                                            <tbody v-for="tour in details.TourPkgRates" :key="tour.pkg_rate_id">
                                                                <tr>
                                                                    ...
                                                                    <td v-if="form.tourists1" class="group" data-label="Select Group Of People">
                                                                        <select @change="onChange($event)"  class="form-select people-group1" :name="'peoplegroup' + tour.pkg_rate_id " :id="'peoplegroup'+tour.pkg_rate_id" v-model="form.tourists1[tour.pkg_rate_id]">
                                                                            <option v-for="item in selectgrouppeoples" :value="item.value" :key="item.value" :selected = "form.tourists1 === item.id">{{ item.number }}</option>
                                                                        </select>
                                                                    </td>

                                                                    <td v-else class="group" data-label="Select Group Of People">
                                                                        <select @change="onChange($event)"  class="form-select people-group1" :name="'peoplegroup' + tour.pkg_rate_id " :id="'peoplegroup'+tour.pkg_rate_id">
                                                                            <option v-for="item in selectgrouppeoples" :value="item.value" :key="item.value">{{ item.number }}</option>
                                                                        </select>
                                                                    </td>


                                                                    <td class="price" data-label="Price" v-if="peopleselects != '' && peopleselects != null">
                                                                        <span class="tag" ><input type="hidden" name="amount" v-model="form.amount">{{ tour.price}}</span>
                                                                    </td>
                                ...
                                <div class="row permit-tax" v-for="TourPkgDetails in details.TourPkgDetails" :key="TourPkgDetails.pkg_rate_id">
                                ...
                                <div class="row hiking-tour-row" v-for="TourPkgDetails in details.TourPkgDetails" :key="TourPkgDetails.pkg_rate_id">
                                    <div class="col-lg-4 col-md-12">
                                        <div class="images-sec">
                                ...
                                <div class="row tour-start-row" >
                                    <div class="col-12 col-sm-12 col-md-6 duration" v-for="TourPkgDetails in details.TourPkgDetails" :key="TourPkgDetails.pkg_rate_id">
                                        <h2>Duration</h2>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 whattobring">
                                        ...
                                        <div class="bring-group" >
                                            <button class="btn-info" v-for="ThingsToBring in details.ThingsToBring" :key="ThingsToBring.pkg_rate_id">{{ ThingsToBring }}</button>
