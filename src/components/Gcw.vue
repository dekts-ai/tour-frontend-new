                                                        ...
                                                        <table class="table table-hover shopping-cart-wrap table-responsive">
                                                            <thead class="text-muted">
                                                                <tr>
                                                                    ...
                                                                    <th scope="col" width="120">Package</th>
                                                                    <th scope="col" width="120">Person's</th>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <img :src="form.package_image" width="100" height="100" class="img-thumbnail img-xs">
                                                                    </td>
                                                                    <td style="align-content: center">
                                                                        <h6 class="title text-truncate">{{ form.package_name }} </h6>
                                                                    </td>
                                                                    <td class="text-center" style="align-content: center">
                                                                        <div class="m-btn-group m-btn-group--pill btn-group mr-2" role="group" aria-label="...">
                                                                            <button @click="decreaseValue()" type="button" class="m-btn btn btn-default"><i class="fa fa-minus"></i></button>
                                                                            <button type="button" class="m-btn btn btn-default" disabled>{{ form.gcw_people }}</button>
                                                                            <button @click="increaseValue()" type="button" class="m-btn btn btn-default"><i class="fa fa-plus"></i></button>
                                                                        </div>
                                                                    </td>
                                                                    <td style="align-content: center">
...
export default {
    ...
    methods: {
        ...
        updateRateGroups(date, calendar = 0, loader) {
            ...
            axios.get("/tour-package/" + date + "/" + this.form.tour_operator_id + "/" + this.form.package_id + "/" + this.form.affiliate_id + "/" + comboIds + "/" + this.with_rate_groups)
                .then((response) => {
                    ...
                    this.form.package_id = response.data.tourPackageData[0].package_id;
                    this.form.package_name = response.data.tourPackageData[0].package_name;
                    this.form.package_image = response.data.tourPackageData[0].FrontendPackageImage;
        ...
        increaseValue() {
            var value = this.form.gcw_people;
            value = isNaN(value) ? 0 : value;
            value++;
            this.form.gcw_people = value;
        },
        decreaseValue() {
            var value = this.form.gcw_people;
            value = isNaN(value) ? 0 : value;
